...
define([
  ...
  'bootstrap',
  'peek',
  'text!templates/sidebar/tplSidebarView.html'
], function($, _, Backbone, Bootstrap, Peek, tplSidebarView){
  ...
  var SidebarView = Backbone.View.extend({
    ...
    render: function(){
      ...
      // Don't actually use the ads for the glist implementation of "todo" but leaving here for future reference
      ...
      var compiledTemplate = _.template( tplSidebarView, data );
